  ...
  const ERPDashboard: React.FC = () => {
    ...
    return (
      <div className={`min-h-screen Rs.{darkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-blue-50 to-indigo-100'}`}>
        <div className="container mx-auto p-6">
          {/* Top Header Section */}
          <div className="mb-8 flex items-center justify-between no-print">
            <div className="flex items-center gap-4">
              <h1 className={`text-4xl font-bold mb-2 Rs.{darkMode ? 'text-white' : 'text-gray-900'}`}>
                MetaBooks
              </h1>
