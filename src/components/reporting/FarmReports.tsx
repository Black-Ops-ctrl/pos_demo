...
const FarmReports = () => {
  ...
  const fetchFormLedgerData = async (branchId: number, flockId: number) => {
    ...
    setError("");
    try {
      const response = await fetch("http://84.16.235.111:2149/api/form-ledger", {
        method: "POST",
        headers: {
  ...
  const fetchFormLedgerCategoryData = async (branchId: number, flockId: number) => {
    ...
    setCategoryError("");
    try {
      const response = await fetch("http://84.16.235.111:2149/api/form-ledger-category-wise", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const fetchFormLedgerSummary = async (branchId: number, flockId: number) => {
    ...
    setSummaryError("");
    try {
      const response = await fetch("http://84.16.235.111:2149/api/form-ledger-summary", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
